...
import $css_3 from 'Frontend/styles/components/tab-bar.css';
addCssBlock(`<custom-style><style>${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/styles/components/navi-drawer.css';
addCssBlock(`<custom-style><style>${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/styles/views/statistics.css';
addCssBlock(`<custom-style><style>${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/styles/components/navi-menu.css';
addCssBlock(`<custom-style><style>${$css_6}</style></custom-style>`);
import $css_7 from 'Frontend/styles/components/charts.css';
...
import $css_10 from 'Frontend/styles/components/view-frame.css';
...
import $css_13 from 'Frontend/styles/components/list-item.css';
...
import $css_15 from 'Frontend/styles/components/brand-expression.css';
...
import $css_19 from 'Frontend/styles/components/navi-item.css';
addCssBlock(`<custom-style><style>${$css_19}</style></custom-style>`);
import $css_20 from 'Frontend/styles/lumo/shadow.css';
